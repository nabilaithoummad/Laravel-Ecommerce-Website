           ...
           <div class="100%" style='overflow-x:scroll'>
            ...
            ?>
                                ...
                                @if (!empty($data))
                                    @foreach ($data as $info)
                                        <tr>
                                            ...
                                            <td style="width: 10%">
                                                <form class="w-100 mt-2" action="{{route('delete_cart',$info->id)}}" method="POST" style="padding: 0">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        <div style="text-align: center;width:100%;">
                            <h3>Total Price : <?php  echo $totale ?> $</h3>
                        </div>
                        <div class="mt-5" style="text-align: center;width:100%;">
                            ...
                            <a href="{{route('stripe',$totale)}}" class="btn btn-danger">Pay Using Card</a>
                        </div>
